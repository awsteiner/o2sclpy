...
class slack_messenger:
    ...
    def set_url_from_env(self,env_var):
        ...
        s_env_var.init_bytes(force_bytes_string(env_var))
        # tag 7
    ...
    def send(self,message,err_on_fail=True):
        ...
        s_message.init_bytes(force_bytes_string(message))
        # tag 7
...
class hist:
    ...
    def from_table(self,t,colx,n_bins):
        ...
        s_colx.init_bytes(force_bytes_string(colx))
        # tag 7
    ...
    def from_table_twocol(self,t,colx,coly,n_bins):
        ...
        s_coly.init_bytes(force_bytes_string(coly))
        # tag 7
...
class hist_2d:
    ...
    def from_table_wgt(self,t,colx,coly,colz,n_bins_x,n_bins_y):
        ...
        s_colz.init_bytes(force_bytes_string(colz))
        # tag 7
