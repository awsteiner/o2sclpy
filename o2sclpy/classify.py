...
class classify_sklearn_gp:
    """
    Classify a data set using scikit-learn's Gaussian Process classifier.
    """
    ...
    def set_data(self,in_data,out_data,outformat='numpy',verbose=0,
                 test_size=0.0,transform_in='none',kernel='1.0*RBF(1.0,(1e-2,1e2))',
                 random_state=None):
        """
        ...
        if self.verbose>0:
            print('classify_sklearn_gp::set_data():')
        ...
        if test_size>0.0:
            try:
                ...
                print('Exception in classify_sklearn_gp::set_data()',
        ...
        try:
            ...
            model = GaussianProcessClassifier(kernel=self.kernel,
    ...
    def eval(self,v):
        ...
        try:
            ...
            print('Exception 4 in classify_sklearn_gp:',e)
    
        if self.outformat=='list':
            return pred.tolist()
   
        if self.verbose>1:
            print('classify_sklearn_gp::eval():',
                'type(pred),pred:',
                type(pred),pred)
