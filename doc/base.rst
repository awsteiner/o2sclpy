...
.. autofunction:: o2sclpy.rearrange_and_copy(t,spec,verbose,err_on_fail)

Function rearrange_and_copy_int
-------------------------------

.. autofunction:: o2sclpy.rearrange_and_copy_int(t,spec,verbose,err_on_fail)

Function rearrange_and_copy_size_t
----------------------------------

.. autofunction:: o2sclpy.rearrange_and_copy_size_t(t,spec,verbose,err_on_fail)

Function grid_rearrange_and_copy
--------------------------------

.. autofunction:: o2sclpy.grid_rearrange_and_copy(t,spec,verbose,err_on_fail)

Function fermi_function
-----------------------

.. autofunction:: o2sclpy.fermi_function(x)

Function bose_function
----------------------

.. autofunction:: o2sclpy.bose_function(x)

Function quadratic_extremum_x
-----------------------------

.. autofunction:: o2sclpy.quadratic_extremum_x(x1,x2,x3,y1,y2,y3)

Function quadratic_extremum_y
-----------------------------

.. autofunction:: o2sclpy.quadratic_extremum_y(x1,x2,x3,y1,y2,y3)

Function screenify
------------------

.. autofunction:: o2sclpy.screenify(nin,in_cols,out_cols,max_size)

Function file_exists
--------------------

.. autofunction:: o2sclpy.file_exists(fname)

Function RGBtoHSV
-----------------

.. autofunction:: o2sclpy.RGBtoHSV(r,g,b,h,s,v)

Function HSVtoRGB
-----------------

.. autofunction:: o2sclpy.HSVtoRGB(h,s,v,r,g,b)

Function wordexp_single_file
----------------------------

.. autofunction:: o2sclpy.wordexp_single_file(fname)

Function wordexp_wrapper
------------------------

.. autofunction:: o2sclpy.wordexp_wrapper(word,matches)

Function function_to_double
---------------------------

.. autofunction:: o2sclpy.function_to_double(s,verbose)

Function function_to_double_nothrow
-----------------------------------

.. autofunction:: o2sclpy.function_to_double_nothrow(s,result,verbose)

Function find_constant
----------------------

.. autofunction:: o2sclpy.find_constant(name,unit)

Function string_to_uint_list
----------------------------

.. autofunction:: o2sclpy.string_to_uint_list(x,list)

Function rewrap_keep_endlines
-----------------------------

.. autofunction:: o2sclpy.rewrap_keep_endlines(str,sv,ncol,verbose,ignore_vt100)

Function vector_level_count
---------------------------

.. autofunction:: o2sclpy.vector_level_count(level,n,x,y)

Function vector_deriv_interp
----------------------------

.. autofunction:: o2sclpy.vector_deriv_interp(n,v,dv,interp_type)

Function vector_deriv2_interp
-----------------------------

.. autofunction:: o2sclpy.vector_deriv2_interp(n,v,dv,interp_type)

Function vector_deriv_xy_interp
-------------------------------

.. autofunction:: o2sclpy.vector_deriv_xy_interp(n,vx,vy,dv,interp_type)

Function vector_deriv2_xy_interp
--------------------------------

.. autofunction:: o2sclpy.vector_deriv2_xy_interp(n,vx,vy,dv,interp_type)

Function vector_integ_interp
----------------------------

.. autofunction:: o2sclpy.vector_integ_interp(n,vx,interp_type)

Function vector_integ_xy_interp
-------------------------------

.. autofunction:: o2sclpy.vector_integ_xy_interp(n,vx,vy,interp_type)

Function vector_integ_ul_interp
-------------------------------

.. autofunction:: o2sclpy.vector_integ_ul_interp(n,x2,v,interp_type)

Function vector_integ_ul_xy_interp
----------------------------------

.. autofunction:: o2sclpy.vector_integ_ul_xy_interp(n,x2,vx,vy,interp_type)

Function vector_find_level
--------------------------

.. autofunction:: o2sclpy.vector_find_level(level,n,x,y,locs)

Function vector_invert_enclosed_sum
-----------------------------------

.. autofunction:: o2sclpy.vector_invert_enclosed_sum(sum,n,x,y,lev,boundaries,verbose,err_on_fail)

Function vector_region_int
--------------------------

.. autofunction:: o2sclpy.vector_region_int(n,x,y,intl,locs,boundaries,verbose,err_on_fail)

Function vector_region_fracint
------------------------------

.. autofunction:: o2sclpy.vector_region_fracint(n,x,y,intl,locs,boundaries,verbose,err_on_fail)

Function vector_bound_fracint
-----------------------------

.. autofunction:: o2sclpy.vector_bound_fracint(n,x,y,frac,low,high,boundaries,verbose,err_on_fail)

Function vector_bound_int
-------------------------

.. autofunction:: o2sclpy.vector_bound_int(n,x,y,frac,low,high,boundaries,verbose,err_on_fail)

Function rebin_xy
-----------------

.. autofunction:: o2sclpy.rebin_xy(x,y,x_out,y_out,n_pts,interp_type)

Function linear_or_log_chi2
---------------------------

.. autofunction:: o2sclpy.linear_or_log_chi2(x,y)

Function linear_or_log_pair
---------------------------

.. autofunction:: o2sclpy.linear_or_log_pair(x,y,log_x,log_y)

Function vector_refine
----------------------

.. autofunction:: o2sclpy.vector_refine(n,index,data,factor,interp_type)

Function linear_or_log
----------------------

.. autofunction:: o2sclpy.linear_or_log(x,log_x)

Function get_screen_size_ioctl
------------------------------

.. autofunction:: o2sclpy.get_screen_size_ioctl(row,col)
